...
"resource": {
  ...
  "rules":[
    ...
    [["if",1,17],["add",18]],
    [["if",1,2],["unless",6],["add",19,21,25,41]],
    [["if",1],["unless",2,6],["add",20,26,29,32]],
    [["if",1],["unless",2,6,9],["add",22]],
    [["if",1,19],["add",27]],
    [["if",1,20],["add",33]],
    [["if",1,2,21],["add",34]],
    [["if",22],["add",36]],
    [["if",1],["unless",2,23,24,25,26],["add",38]]]
},
"runtime":[]
...
return null},xd=!1;if(H.querySelectorAll)try{var yd=H.querySelectorAll(":root");yd&&1==yd.length&&yd[0]==H.documentElement&&(xd=!0)}catch(a){}var rd=xd;var Md={},K=null,Nd=Math.random();Md.C="GTM-5W9QXH7";Md.Rb="871";Md.Ih="";var Od={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Pd="www.googletagmanager.com/gtm.js";
var Qd=Pd,Rd=null,Sd=null,Td="//www.googletagmanager.com/a?id="+Md.C+"&cv=174",Ud={},Vd={},Wd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
return!a}function Pk(){var a=Ok();try{ik(G["GTMDataLayer"],Md.C)}catch(b){}return a}
var Rk=function(){var a=Jc("GTMDataLayer",[]),b=Jc("google_tag_manager",{});b=b["GTMDataLayer"]=b["GTMDataLayer"]||{};dh(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});ok(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var e;if(0<K.SANDBOXED_JS_SEMAPHORE){e=[];for(var f=0;f<arguments.length;f++)e[f]=new Hk(arguments[f])}else e=[].slice.call(arguments,0);var h=c.apply(a,e);Ik.push.apply(Ik,e);if(300<
